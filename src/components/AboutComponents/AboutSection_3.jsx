      ...
      <div className="xl:w-[70vw] mx-auto">
        ...
        <div className="flex flex-col xl:flex-row gap-5">
          <div className="basis-1/1 xl:basis-2/3 bg-[#eaf6ff] order-0 pb-[150px] xl:pb-[0px]">
            ...
            <p className="spacegrotesk500 text-justify text-[14px] leading-[20px] md:text-[14px] pl-[10px] pr-[5px] pt-[10px] sm:px-[30px] xl:text-[15px] xl:leading-[20px] xl:pl-[30px] xl:pr-[30px] xl:py-[20px]">
